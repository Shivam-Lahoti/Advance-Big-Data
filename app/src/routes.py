...
from src.controllers.controllers import create_data,read_data,delete_data_by_key,read_all_data,patch_data_by_key
...
def register_routes(app: Flask):
    ...
    app.add_url_rule('/plan/<string:key>','patch_data_by_key',patch_data_by_key, methods=['PATCH'])
